...
void FVM::Core::CommonFunctions::Convert::iimage2mat(Objects::Image::IImage* image, cv::Mat* mat)
{
...
void FVM::Core::CommonFunctions::Convert::mat2iimage(cv::Mat *mat, Objects::Image::IImage *image)
{
	for (int i = 0; i < image->rows(); i++)
	{
		for (int j = 0; j < image->cols(); j++)
