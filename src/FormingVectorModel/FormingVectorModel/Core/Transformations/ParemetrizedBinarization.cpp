...
Core::Transformations::ParemetrizedBinarization::ParemetrizedBinarization(int threshold) : threshold_(threshold)
{
}

void Core::Transformations::ParemetrizedBinarization::execute(Objects::Visual::IImage* image)
{
