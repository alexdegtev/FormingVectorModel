...
void Core::Transformations::GuoHallSkeletization::execute(Objects::Visual::IImage* image)
{
...
void Core::Transformations::GuoHallSkeletization::thinning(cv::Mat& im)
{
	im /= 255;
...
void Core::Transformations::GuoHallSkeletization::thinning_iteration(cv::Mat& im, int iter)
{
